...
void initUART2(void);
int putc(struct _USART *UART, int c);
int puts(struct _USART *UART, const char *s);
void printchar(struct _USART *UART, char **str, int c);
int prints(struct _USART *UART, char **out, const char *string, int width, int pad);
int printi(struct _USART *UART, char **out, int i, int b, int sg, int width, int pad, int letbase);
int print(struct _USART *UART, char **out, int *varg);
int printf(struct _USART *UART, const char *format, ...);
